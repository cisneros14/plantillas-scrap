...
export function ValuesSection() {
  ...
  return (
    <section className="py-24 bg-background/50 dark:bg-neutral-900/50">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((item, index) => (
            <Card
              key={index}
              className="text-center border-none shadow-md hover:shadow-lg transition-shadow bg-white dark:bg-neutral-900"
            >
              <CardHeader>
