...
export function TeamSection() {
  ...
  return (
    <section className="py-24 bg-background/70 border-y dark:bg-amber-950/20 dark:border-amber-900/30">
      <div className="container px-4 mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Mentes creativas y técnicas trabajando juntas por tu éxito.
          </p>
        </div>
